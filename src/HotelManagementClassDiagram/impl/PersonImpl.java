 ...
 *   <li>{@link HotelManagementClassDiagram.impl.PersonImpl#getAdress <em>Adress</em>}</li>
...
public abstract class PersonImpl extends MinimalEObjectImpl.Container implements Person {
	...
	public void setAdress(String newAdress) {
		...
		adress = newAdress;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HotelManagementClassDiagramPackage.PERSON__ADRESS, oldAdress, adress));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HotelManagementClassDiagramPackage.PERSON__NAME:
				return getName();
			case HotelManagementClassDiagramPackage.PERSON__ADRESS:
				return getAdress();
